...
export default async function AdminDashboard() {
  ...
  // R2 Edge Network Analytics (Or fallback metrics)
  let totalBytes = 0
  let totalObjects = 0
  ...
  if (process.env.R2_ACCOUNT_ID) {
    try {
      ...
      console.error("R2 Analytics Request Failed", e)
      r2Status = "DEGRADED"
    }
  }
  ...
  return (
    <div className="max-w-7xl pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 border-b border-neutral-200 pb-4 gap-4">
        <h1 className="text-3xl font-['Bebas_Neue'] tracking-wider text-[#09090B] flex items-center gap-3">
          SYSTEM <span className="text-[#10B981]">ANALYTICS</span>
        </h1>
