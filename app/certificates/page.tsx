    ...
    <div className="flex flex-col min-h-screen bg-[#FAFAFA] pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-6 w-full">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-['Bebas_Neue'] tracking-widest text-[#09090B] mb-6">
            REGULATORY <span className="text-[#10B981]">COMPLIANCE</span>
          </h1>
          <p className="font-['Lora'] text-[#52525B] text-lg leading-relaxed">
        ...
        {certs.length === 0 ? (
           <div className="text-center py-20 bg-[#FFFFFF] border border-neutral-200">
             <p className="font-['DM_Mono'] text-xs uppercase tracking-widest text-[#52525B]">No compliance certificates publicly active.</p>
           </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {certs.map(cert => (
              <div key={cert.id} className="bg-[#FFFFFF] border border-neutral-200 p-8 hover:border-[#10B981] transition-colors group relative overflow-hidden">
                ...
                <h3 className="text-xl font-bold font-['DM_Mono'] text-[#09090B] uppercase tracking-wide mb-6 group-hover:text-[#10B981] transition-colors">
                  {cert.title}
                </h3>
