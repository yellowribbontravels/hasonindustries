...
export default function ContactPage() {
  return (
    <div className="flex flex-col min-h-screen">
      <div className="pt-40 pb-32 px-6 max-w-7xl mx-auto w-full relative z-10">
        <h1 className="text-6xl md:text-8xl lg:text-[100px] font-['Bebas_Neue'] tracking-widest text-[#09090B] mb-8 pb-8 border-b border-neutral-300 leading-[0.85]">
          SECURE <span className="text-[#10B981]">CONNECTION</span>
        </h1>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-12">
          <div className="flex flex-col gap-12">
             <p className="font-['Lora'] text-[#52525B] text-lg leading-relaxed max-w-lg">
             ...
             <div className="flex flex-col gap-8 font-['DM_Mono'] text-sm tracking-widest uppercase">
               <div className="border-l-2 border-[#10B981] pl-4">
                 <p className="text-[#52525B] text-[10px] mb-2">Global Headquarters</p>
